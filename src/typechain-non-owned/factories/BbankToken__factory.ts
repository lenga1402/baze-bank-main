...
import type { BbankToken, BbankTokenInterface } from "../BbankToken";
...
export class BbankToken__factory {
  static readonly abi = _abi;
  static createInterface(): BbankTokenInterface {
    return new utils.Interface(_abi) as BbankTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BbankToken {
    return new Contract(address, _abi, signerOrProvider) as BbankToken;
  }
}
